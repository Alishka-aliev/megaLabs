...
class  PhpExcelTones
{
    ...
    public function getHeaderTitle()
    {
        return [
            ...
            'code' => array('name' => 'Код трека', 'column' => 'D', 'width' => 20),
            'artist' => array('name' => 'Исполнитель', 'column' => 'E', 'width' => 20),
            'price' => array('name' => 'Цена', 'column' => 'F', 'width' => 15),
            'shortCode' => array('name' => 'Короткий код', 'column' => 'G', 'width' => 15),
            'contract' => array('name' => 'Контракты', 'column' => 'H', 'width' => 70),
            'platforms' => array('name' => 'Платформы', 'column' => 'I', 'width' => 70),
        ];
    }
